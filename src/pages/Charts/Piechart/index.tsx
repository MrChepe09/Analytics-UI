...
import { BarChart3, LineChart, TrendingUp, Activity, Github, Twitter, Mail, Menu, X, Copy, Check, Code2, Eye, ArrowLeft } from 'lucide-react';
...
export default function PieChartPage() {
  ...
  const chartCode = `import { PieChart, Pie, Cell, Tooltip, ResponsiveContainer } from 'recharts';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-8">
            <div className="flex items-center space-x-4 mb-4">
              ...
              <div>
                <h1 className="text-3xl sm:text-4xl font-bold text-white mb-2">Pie Chart</h1>
                <p className="text-lg text-white/80">Perfect for showing trends over time</p>
              </div>
            </div>
            <p className="text-white/70 max-w-3xl leading-relaxed">
              Great for showing proportions and percentages. Perfect for market share, demographics, or any part-to-whole relationships.
            </p>
          </div>
