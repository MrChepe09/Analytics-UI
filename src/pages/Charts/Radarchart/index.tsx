...
import { LineChart as RechartsLineChart, Line, XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer, BarChart as RechartsBarChart, Bar, PieChart as RechartsPieChart, Cell, Pie, AreaChart, Area, PolarGrid, Radar, PolarRadiusAxis, PolarAngleAxis } from 'recharts';
...
export default function RadarChartPage() {
  ...
  const chartCode = `import { RadarChart, Radar, PolarGrid, PolarAngleAxis, PolarRadiusAxis, Tooltip, ResponsiveContainer } from 'recharts';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-8">
            <div className="flex items-center space-x-4 mb-4">
              ...
              <div>
                <h1 className="text-3xl sm:text-4xl font-bold text-white mb-2">Radar Chart</h1>
                <p className="text-lg text-white/80">Perfect for showing trends over time</p>
              </div>
            </div>
            <p className="text-white/70 max-w-3xl leading-relaxed">
              Great for comparing multiple variables across categories. Useful for skill assessments, survey results, or feature evaluations.
            </p>
          </div>
