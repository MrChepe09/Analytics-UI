...
export default function BarChartPage() {
  ...
  const chartCode = `import { BarChart, Bar, XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer } from 'recharts';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-8">
            <div className="flex items-center space-x-4 mb-4">
              ...
              <div>
                <h1 className="text-3xl sm:text-4xl font-bold text-white mb-2">Bar Chart</h1>
                <p className="text-lg text-white/80">Perfect for showing trends over time</p>
              </div>
            </div>
            <p className="text-white/70 max-w-3xl leading-relaxed">
             Ideal for comparing different categories or showing distribution. Perfect for sales data, survey results, or any categorical comparison.
            </p>
          </div>
