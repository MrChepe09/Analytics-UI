...
import { BarChart3, PieChart, TrendingUp, Activity, Github, Twitter, Mail, Menu, X, Copy, Check, Code2, Eye, ArrowLeft } from 'lucide-react';
...
export default function LineChartPage() {
  ...
  const chartCode = `import { LineChart, Line, XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer } from 'recharts';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-8">
            <div className="flex items-center space-x-4 mb-4">
              ...
              <div>
                <h1 className="text-3xl sm:text-4xl font-bold text-white mb-2">Line Chart</h1>
                <p className="text-lg text-white/80">Perfect for showing trends over time</p>
              </div>
            </div>
            <p className="text-white/70 max-w-3xl leading-relaxed">
              Line charts are ideal for displaying continuous data and showing trends, changes, and relationships over time. 
              They're perfect for metrics like revenue growth, user engagement, performance data, and any time-series analysis. 
              This component supports multiple data series, custom styling, and responsive design.
            </p>
          </div>
